...
It is not exhaustive, and it is not a sales document. It is an attempt to show that business can be done in a clear, structured way, and to be judged on it.
...
Anyone in the team can propose a change, and is encouraged to. A section changes when a decision changes the practice behind it. The final call sits with the company's leadership.
...
Third-party components under open or closed licences stay under their own terms, because we cannot transfer what was never ours. We name them before you commit. Full details in [ownership and handover](https://playbook.volcanicminds.com/how-we-work#ownership-and-handover).

## Do you work on-site with partners?

We are remote by choice: cost, access to talent, work-life balance and reach. That is our default. But a relationship is not built entirely through a screen, so we meet in person when a project needs it, typically at the start and around key milestones.
