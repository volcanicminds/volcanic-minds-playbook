...
We are a small, fully remote team, and we would rather describe our structure as it is than as an org chart we have not needed yet.
...
## Tech budget & benefits

Technology is the job, so everyone is equipped for it from day one: laptop, software and the professional subscriptions the role needs. Collaborators with 2+ years receive a personal budget for devices (laptops, smartphones, tablets), renewed every two years.

Beyond that:

-   **Software & subscriptions**: access to professional tools, and we listen to proposals for new ones.
-   **Professional opportunities**: tech events, training programs and workshops.
-   **Meal vouchers**.
...
Everyone receives the leave they are legally entitled to, and we do not impose company-wide shutdown periods: needs differ, so the calendar is yours to plan.

On top of statutory leave:

-   **Your birthday**: an extra paid day off.
-   **Mental health days**: two paid days, usable in spring or autumn.
-   **San Giovanni**: June 24th, paid (patron saint of Turin).
-   **Flexible days**: up to three unpaid days for personal development, cultural activities or volunteering.

We ask only that days are planned in advance with your manager, so that neither colleagues nor partners are left uncovered.
...
**Termination**: the most serious form of separation, reserved for serious misconduct, poor performance or policy violations. Decisions rest on documented reasons and follow company policy and the law, and are handled with fairness and discretion.