...
We grow by deepening our service lines rather than widening our catalogue. From tech startups and SMEs to larger enterprises, the pattern is the same: existing partnerships expand because the work is good, and new ones arrive because someone talked about it.
...
These are directions, reviewed each year. They are not measurable targets, and we would rather say so than dress them up as metrics we don't publish:
...
Our main business is **service delivery**, but we do take equity in projects we believe in. We look at ambitious ones, usually in their growth or maintenance phase, which suits partners looking for alternative financing.

We check each opportunity for real alignment with our mission and for a realistic path to shared results. Most of the ones we look at, we decline.
...
We maintain a suite of open-source projects in TypeScript and Node.js:
